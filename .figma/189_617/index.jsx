    ...
    <div className={styles.frame3}>
        ...
        <div className={styles.frame8}>
          <div className={styles.roleSelector}>
            <div className={styles.frame12}>
              <img
                src="../image/mium70uc-o6ma4n7.svg"
          ...
          <div className={styles.roleSelector2}>
            <div className={styles.frame122}>
              <img
                src="../image/mium70uc-4qkfhgl.svg"
                className={styles.briefcase}
              />
      ...
      <div className={styles.frame10}>
        <div className={styles.inputText}>
          <p className={styles.label}>Organization / business name</p>
        ...
        <div className={styles.inputPassword}>
          ...
          <div className={styles.frame13}>
            ...
            <img src="../image/mium70uc-p0vi86x.svg" className={styles.briefcase} />
          </div>
        </div>
        <div className={styles.inputPassword}>
